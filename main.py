...
def create_random_gene() -> Gene:
    ...
    chord_notes = get_chord(lead_note, chord_offsets)
...
INPUT_FILENAME = 'mid/input1.mid'
OUTPUT_FILENAME = 'mid/my_output1.mid'
...
if __name__ == "__main__":
    ...
    # change leading not if key is MINOR, to get appropriate consonant chords
